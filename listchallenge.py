...
print('My favorite character is',  heroes[4])

# PART 2
# Ask the user to pick a number between 1 and 100.
# Convert the input into an integer.

pick = int(input('Pick a number from 1 to 100: '))
print('You chose:', str(pick) + '. It is type:', type(pick))
...
print('The biggest number in the list is: ' + str(max(nums)))
